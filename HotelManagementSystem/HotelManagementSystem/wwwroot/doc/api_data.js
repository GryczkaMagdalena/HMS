define({ "api": [
  ...
  {
    "type": "get",
    "url": "/Task/CustomerTasks",
    "title": "CustomerTasks",
    "version": "0.1.5",
    "name": "GetCustomerTasks",
    "group": "Task",
    "description": "<p>Gets all tasks issued by customer</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "tasks",
            "description": "<p>List of every issued task</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/Worker/ManagerShifts",
    "title": "ActualizeManagerShifts",
    "version": "0.1.5",
    "name": "ActualizeManagerShifts",
    "group": "Worker",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "get",
    "url": "/Worker/CurrentShift",
    "title": "GetWorkerCurrentShift",
    "version": "0.1.5",
    "name": "CurrentShift",
    "group": "Worker",
    "success": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "current",
            "description": "<p>True if shift is pending, false if future shift</p>"
          },
          {
            "group": "Success 200",
            "type": "Shift",
            "optional": false,
            "field": "shift",
            "description": "<p>Shift object with properties</p>"
          }
        ]
      },
      "examples": [
