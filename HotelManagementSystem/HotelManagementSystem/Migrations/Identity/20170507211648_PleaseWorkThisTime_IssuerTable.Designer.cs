...
namespace HotelManagementSystem.Migrations.Identity
{
    ...
    [Migration("20170507211648_PleaseWorkThisTime_IssuerTable")]
    partial class PleaseWorkThisTime_IssuerTable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HotelManagementSystem.Models.Entities.Storage.Room", b =>
                {
                    b.HasOne("HotelManagementSystem.Models.Entities.Identity.User", "User")
                        .WithOne("Room")
                        .HasForeignKey("HotelManagementSystem.Models.Entities.Storage.Room", "UserID");
                });
